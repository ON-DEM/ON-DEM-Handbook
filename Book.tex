...
\title{Handbook of \\ normalisation and \\ best practice for DEM \\ simulations}
\newcommand{\booksubtitle}{Open Network on DEM Simulations  (ON-DEM)}
\newcommand{\booklicense}{CC BY 4.0}

\author{Anthony Thornton, David Schneider}
...
% Title
\textbf{\fontfamily{qcs}\fontsize{28}{34}\selectfont Handbook of \\ normalisation and \\ best practice for DEM \\ simulations}
...
\input{Chapters/CFDDEMCourse.tex}
